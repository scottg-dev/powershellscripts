...
if (!(Test-Path $PDSWorkingDir))
{
New-Item -ItemType Directory -Force -Path $PDSWorkingDir
}
WriteToLog $LogLevelInfo , 'Got past that error!'
...
$X1 = $EdeAppsNetDir + $string1 + $AppGroupAbbr + '\schemas'
$X2 = $ProjStdGEPath + '\' + $AppGroupAbbr + '\schemas'
$X3 = $ProjStdDiscPath + '\' + $AppGroupAbbr + '\schemas'
...
$X4 = $EdeAppsNetDir + $string1 + $AppGroupAbbr +'\'
$X5 = $ProjStdGEPath + '\' + $AppGroupAbbr + '\'
$X6 = $ProjStdDiscPath + '\' + $AppGroupAbbr + '\'
$file = "pds.cmd"
if (Test-Path $X4)
{
...
$X7 = $EdeAppsNetDir + $string1 + $AppGroupAbbr
...
$X9 = $ProjStdDiscPath + '\' + $AppGroupAbbr
